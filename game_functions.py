...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button):
    ...
    # Redraw the screen and set the background color while passing through the loop.
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if collisions:
        # if an entire fleet is distoryed, start a new level
...
def create_alien(ai_settings, screen, aliens, alien_number, row_number):
    ...
    # add alien to the alien sprite's group
    aliens.add(alien)
...
def check_aliens_bottom(ai_settings, stats, sb, screen, ship, aliens, bullets):
    ...
    for alien in aliens.sprites():
        if alien.rect.bottom >= screen_rect.bottom:
            ...
            ship_hit(ai_settings, stats, sb, screen, aliens, bullets)
            break
